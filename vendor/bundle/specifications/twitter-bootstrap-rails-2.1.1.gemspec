...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<therubyracer>, ["#<YAML::Syck::DefaultKey:0x1020e3898> 0.10.1"])
      s.add_runtime_dependency(%q<less-rails>, ["~> 2.2.2"])
      s.add_development_dependency(%q<rails>, [">= 3.1"])
    else
      s.add_dependency(%q<railties>, [">= 3.1"])
      s.add_dependency(%q<actionpack>, [">= 3.1"])
      s.add_dependency(%q<therubyracer>, ["#<YAML::Syck::DefaultKey:0x1020e3898> 0.10.1"])
