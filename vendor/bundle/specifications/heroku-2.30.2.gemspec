...
Gem::Specification.new do |s|
  ...
  s.licenses = ["MIT"]
  s.post_install_message = %q{ !    Heroku recommends using the Heroku Toolbelt to install the CLI.
 !    Download it from: https://toolbelt.heroku.com
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<heroku-api>, ["~> 0.3.2"])
      s.add_runtime_dependency(%q<netrc>, ["~> 0.7.5"])
      s.add_runtime_dependency(%q<rest-client>, ["~> 1.6.1"])
      s.add_runtime_dependency(%q<launchy>, [">= 0.3.2"])
      s.add_runtime_dependency(%q<rubyzip>, [">= 0"])
    else
      s.add_dependency(%q<heroku-api>, ["~> 0.3.2"])
      s.add_dependency(%q<netrc>, ["~> 0.7.5"])
